<template>
    ...
    <div class="modal main__modal" :class="{ show: showModal }">
        <div class="modal__content">
            <span class="modal__close btn__close--modal" @click="openModal()"
                >×</span
            >
...
export default {
    ...
    setup(props) {
        ...
        const deleteInvoiceItem = (id, i) => {
            ...
            if (id != undefined) {
                axios.get("/api/invoices/delete_items/" + id);
            }
        };
        ...
        const onEdit = (id) => {
            if (form.value.invoice_items.length >= 1) {
                ...
                try {
                    axios.post(
                        `/api/invoices/update/${form.value.id}`,
                        formData
                    );
